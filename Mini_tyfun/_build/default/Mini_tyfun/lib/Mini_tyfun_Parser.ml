...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState32 : (('s, _menhir_box_prg) _menhir_cell1_opp, _menhir_box_prg) _menhir_state
    (** State 32.
        Stack shape : opp.
        Start symbol: prg. *)
  ...
  | MenhirState38 : (('s, _menhir_box_prg) _menhir_cell1_opp, _menhir_box_prg) _menhir_state
    (** State 38.
        Stack shape : opp.
        Start symbol: prg. *)

  | MenhirState40 : (('s, _menhir_box_prg) _menhir_cell1_opp, _menhir_box_prg) _menhir_state
    (** State 40.
        Stack shape : opp.
        Start symbol: prg. *)

  | MenhirState42 : (('s, _menhir_box_prg) _menhir_cell1_opp, _menhir_box_prg) _menhir_state
    (** State 42.
        Stack shape : opp.
        Start symbol: prg. *)

  | MenhirState44 : (('s, _menhir_box_prg) _menhir_cell1_opp, _menhir_box_prg) _menhir_state
    (** State 44.
        Stack shape : opp.
        Start symbol: prg. *)

  | MenhirState46 : (('s, _menhir_box_prg) _menhir_cell1_opp, _menhir_box_prg) _menhir_state
    (** State 46.
        Stack shape : opp.
        Start symbol: prg. *)
...
and ('s, 'r) _menhir_cell1_opp = 
  | MenhirCell1_opp of 's * ('s, 'r) _menhir_state * (Mini_tyfun.term)
...
let _menhir_action_01 =
  fun t1 t2 ->
    (
# 53 "Mini_tyfun/lib/Mini_tyfun_Parser.mly"
                              ( app t1 t2 )
...
let _menhir_action_03 =
  fun n ->
    (
# 57 "Mini_tyfun/lib/Mini_tyfun_Parser.mly"
            ( int_ n )
...
let _menhir_action_07 =
  fun t1 t2 x ->
    (
# 36 "Mini_tyfun/lib/Mini_tyfun_Parser.mly"
                                                       ( let_ x t1 t2 )
...
let _menhir_action_12 =
  fun t1 t2 ->
    (
# 67 "Mini_tyfun/lib/Mini_tyfun_Parser.mly"
                                                    ( arrow t1 t2 )
...
let _menhir_action_14 =
  fun () ->
    (
# 71 "Mini_tyfun/lib/Mini_tyfun_Parser.mly"
             ( int_type )
...
let _menhir_action_17 =
  fun i ->
    (
# 63 "Mini_tyfun/lib/Mini_tyfun_Parser.mly"
            ( i )
...
let _menhir_action_19 =
  fun t1 t2 ->
    (
# 43 "Mini_tyfun/lib/Mini_tyfun_Parser.mly"
                             ( op or_ t1 t2 )
...
let _menhir_action_27 =
  fun t ->
    (
# 33 "Mini_tyfun/lib/Mini_tyfun_Parser.mly"
                   ( t )
...
include struct
  ...
  and _menhir_goto_app_expr : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prg) _menhir_state -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | AND | ELSE | EOF | IN | MINOR | MINUS | OR | PLUS | RPAREN | THEN | TIMES ->
          ...
          _menhir_goto_opp _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      | _ ->
          _eRR ()
  ...
  and _menhir_run_34 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prg) _menhir_state -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      let n = _v in
  ...
  and _menhir_goto_opp : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prg) _menhir_state -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match _menhir_s with
      | MenhirState00 ->
  ...
  and _menhir_run_31 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prg) _menhir_state -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
          let _menhir_stack = MenhirCell1_opp (_menhir_stack, _menhir_s, _v) in
  ...
  and _menhir_run_32 : type  ttv_stack. (ttv_stack, _menhir_box_prg) _menhir_cell1_opp -> _ -> _ -> _menhir_box_prg =
  ...
  and _menhir_run_38 : type  ttv_stack. (ttv_stack, _menhir_box_prg) _menhir_cell1_opp -> _ -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer ->
  ...
  and _menhir_run_42 : type  ttv_stack. (ttv_stack, _menhir_box_prg) _menhir_cell1_opp -> _ -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer ->
  ...
  and _menhir_run_44 : type  ttv_stack. (ttv_stack, _menhir_box_prg) _menhir_cell1_opp -> _ -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer ->
  ...
  and _menhir_run_46 : type  ttv_stack. (ttv_stack, _menhir_box_prg) _menhir_cell1_opp -> _ -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer ->
  ...
  and _menhir_run_33 : type  ttv_stack. (ttv_stack, _menhir_box_prg) _menhir_cell1_opp -> _ -> _ -> _ -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      let MenhirCell1_opp (_menhir_stack, _menhir_s, t1) = _menhir_stack in
      let t2 = _v in
      let _v = _menhir_action_24 t1 t2 in
      _menhir_goto_opp _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
  
  and _menhir_run_39 : type  ttv_stack. ((ttv_stack, _menhir_box_prg) _menhir_cell1_opp as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prg) _menhir_state -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
          let _menhir_stack = MenhirCell1_opp (_menhir_stack, _menhir_s, _v) in
          _menhir_run_32 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | ELSE | EOF | IN | MINOR | MINUS | OR | PLUS | RPAREN | THEN ->
          let MenhirCell1_opp (_menhir_stack, _menhir_s, t1) = _menhir_stack in
          let t2 = _v in
  ...
  and _menhir_run_41 : type  ttv_stack. ((ttv_stack, _menhir_box_prg) _menhir_cell1_opp as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prg) _menhir_state -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
          let _menhir_stack = MenhirCell1_opp (_menhir_stack, _menhir_s, _v) in
  ...
  and _menhir_run_43 : type  ttv_stack. ((ttv_stack, _menhir_box_prg) _menhir_cell1_opp as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prg) _menhir_state -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
          let _menhir_stack = MenhirCell1_opp (_menhir_stack, _menhir_s, _v) in
  ...
  and _menhir_run_45 : type  ttv_stack. ((ttv_stack, _menhir_box_prg) _menhir_cell1_opp as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prg) _menhir_state -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
          let _menhir_stack = MenhirCell1_opp (_menhir_stack, _menhir_s, _v) in
      ...
      | MINUS ->
          let _menhir_stack = MenhirCell1_opp (_menhir_stack, _menhir_s, _v) in
          _menhir_run_42 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | ELSE | EOF | IN | MINOR | OR | RPAREN | THEN ->
          let MenhirCell1_opp (_menhir_stack, _menhir_s, t1) = _menhir_stack in
          let t2 = _v in
  ...
  and _menhir_run_47 : type  ttv_stack. ((ttv_stack, _menhir_box_prg) _menhir_cell1_opp as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prg) _menhir_state -> _ -> _menhir_box_prg =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
          let _menhir_stack = MenhirCell1_opp (_menhir_stack, _menhir_s, _v) in
